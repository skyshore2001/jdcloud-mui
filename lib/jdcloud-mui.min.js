...
{if(self.activePage){var jpage=self.activePage;var H=self.container.height();var jo,hd,ft;jo=jpage.find(">.hd");hd=(jo.size()>0&&jo.css("display")!="none")?jo.height():0;ft=0;jpage.find(">.ft").each(function(){if($(this).is(":visible"))
ft+=$(this).height();});jpage.height(H);jpage.find(">.bd").css({top:hd,bottom:ft});}}
...
var jft=jpage.find(".ft");if(jft.size()>0){setTimeout(function(){jft.css("bottom",jfooter.height());});}
