...
{var map={};$.each(str.split(sep),function(i,e){var kv=e.split(sep2,2);assert(kv.length==2,"bad kvList: "+str);map[kv[0]]=kv[1];});return map;}
function initModule()
...
var str1='';var bracket2=false;$.each(v1.split(/\s*,\s*/),function(j,v2){if(str1.length>0){str1+=" OR ";bracket2=true;}
var m=v2.match(/^(\d+)-(\d+)$/);if(m){str1+="("+k+">="+m[1]+" AND "+k+"<="+m[2]+")";}
else{str1+=k+getop(v2);}});if(bracket2)
str+="("+str1+")";else
str+=str1;});if(bracket)
