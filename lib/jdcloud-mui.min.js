...
{if(param==null)
return url;var ret;var a=url.split("#");if(a.length>1){ret=a[0]+(url.indexOf('?')>0?"&":"?")+param+"#"+a[1];}
else{ret=url+(url.indexOf('?')>0?"&":"?")+param;}
return ret;}
...
{delete g_args[param];var search=MUI.deleteParam(location.search,param);MUI.setUrl(search);}
